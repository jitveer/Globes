...
exports.uploadImage = asyncHandler(async (req, res, next) => {
  ...
  try {
    const destDir = path.join("uploads", "blogs");

    // Process image using imageOptimizer microservice (converts to WebP, optimizes, etc.)
    ...
    // Return the high-quality optimized webp URL to Editor.js / Frontend
    const url = `${req.protocol}://${req.get("host")}${optimized.webp}`;
...
exports.updateBlog = asyncHandler(async (req, res, next) => {
  try {
    ...
    // Safely update fields, avoiding populated objects or immutable fields
