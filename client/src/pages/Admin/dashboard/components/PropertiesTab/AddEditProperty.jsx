            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => {
                    // Delay slightly to allow click handler on suggestion to register
                ...
                {showSuggestions && (
                  <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                    {BANGALORE_AREAS.filter((area) =>
                      area.toLowerCase().includes((formData.location.area || "").toLowerCase())
                    ).map((area) => (
                      <button
                        key={area}
                        type="button"
                        ...
                        className="w-full text-left px-4 py-2.5 hover:bg-orange-50 hover:text-orange-600 transition-colors text-sm font-medium border-b border-gray-100 last:border-0"
                      >
                        {area}
                      </button>
                    ))}
                    {BANGALORE_AREAS.filter((area) =>
                      area.toLowerCase().includes((formData.location.area || "").toLowerCase())
                        ...
                        <div className="px-4 py-3 text-sm text-gray-500 italic bg-gray-50">
                          No matches found (will save as typed)
                        </div>
                      )}
                  </div>
                )}
